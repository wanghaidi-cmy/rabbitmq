...
public class Consumer1 {
    public static void main(String[] args) throws IOException, TimeoutException {
         ...
         * 参数5：队列其他参数
         */
        channel.queueDeclare(Producer.TOPICS_QUEUE1, true, false, false, null);
        /**
         * 5.队列绑定交换机
         */
        channel.queueBind(Producer.TOPICS_QUEUE1, Producer.TOPICS_EXCHANGE, "topic.update");
        ...
        DefaultConsumer defaultConsumer = new DefaultConsumer(channel) {
            ...
            public void handleDelivery(String consumerTag, Envelope envelope, AMQP.BasicProperties properties, byte[] body) throws IOException {
                ...
                System.out.println("消费者--1接收道德消息为：" + new String(body, "utf-8"));
            }
        };
        /**
         * 7.监听消息
         ...
         * 参数3：消息接收到后回调
         */
        channel.basicConsume(Producer.TOPICS_QUEUE1,true,defaultConsumer);
    }
}
